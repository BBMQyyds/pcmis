...
(
  ...
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='劳动案件表';
...
/*!40000 ALTER TABLE `_case`
    DISABLE KEYS */;
INSERT INTO `_case`
VALUES (1, 1, '2025-03-01 10:00:00', '王小明', 50.00, 3, '某建筑公司', '工程建设', '处理中', 4, 20.00, 1,
        '2025-03-03 15:52:29', '2025-03-03 15:52:29'),
       (2, 2, '2025-03-02 14:30:00', '李大军', 80.00, 5, '某施工单位', '工程建设', '待受理', 4, 0.00, 0,
        '2025-03-03 15:52:29', '2025-03-03 15:52:29');
/*!40000 ALTER TABLE `_case`
    ENABLE KEYS */;
UNLOCK TABLES;
...
(
  ...
  AUTO_INCREMENT = 5
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='附件管理表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
VALUES (1, '项目合同', 1, '市政道路改造合同.pdf', '/uploads/contracts/project1.pdf', 204800, 3, '2025-03-03 15:53:23'),
       (2, '保证金凭证', 2, '住宅小区建设保证金缴纳凭证.jpg', '/uploads/deposits/project2.jpg', 102400, 3,
        '2025-03-03 15:53:23'),
       (3, '案件证据', 1, '工资拖欠证据.png', '/uploads/evidence/case1.png', 512000, 4, '2025-03-03 15:53:23'),
       (4, '案件证据', 2, '工地录音证据.mp3', '/uploads/evidence/case2.mp3', 1048576, 4, '2025-03-03 15:53:23');
/*!40000 ALTER TABLE `attachment`
    ENABLE KEYS */;
UNLOCK TABLES;
...
(
  ...
  AUTO_INCREMENT = 3
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='案件证据链表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40000 ALTER TABLE `case_evidence`
    DISABLE KEYS */;
INSERT INTO `case_evidence`
VALUES (1, 1, '书面证据', '合同副本及工资支付记录'),
       (2, 2, '视听资料', '现场录音证据');
/*!40000 ALTER TABLE `case_evidence`
    ENABLE KEYS */;
UNLOCK TABLES;
...
(
  ...
  AUTO_INCREMENT = 3
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='案件回访记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40000 ALTER TABLE `case_followup`
    DISABLE KEYS */;
INSERT INTO `case_followup`
VALUES (1, 1, '2025-03-05 09:30:00', '投诉人表示已收到部分款项', 4),
       (2, 2, '2025-03-06 10:00:00', '案件正在处理中', 4);
/*!40000 ALTER TABLE `case_followup`
    ENABLE KEYS */;
UNLOCK TABLES;
...
(
  ...
  AUTO_INCREMENT = 3
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='案件处理流程表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40000 ALTER TABLE `case_process`
    DISABLE KEYS */;
INSERT INTO `case_process`
VALUES (1, 1, '接待意见', '案件已受理，等待进一步调查', 4, '2025-03-03 15:52:29'),
       (2, 2, '监察意见', '已调查相关证据，建议调解', 4, '2025-03-03 15:52:29');
/*!40000 ALTER TABLE `case_process`
    ENABLE KEYS */;
UNLOCK TABLES;
...
(
  ...
  AUTO_INCREMENT = 3
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='工程项目表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40000 ALTER TABLE `project`
    DISABLE KEYS */;
INSERT INTO `project`
VALUES (1, '市政道路改造工程', '某市政建设局', '某建筑公司', 5000.00, '北京市朝阳区', '2025-01-15', '2025-02-01',
        '在建', 200.00, '已缴纳', '保函', 1, 3, '2025-03-03 15:52:29', '2025-03-03 15:52:29'),
       (2, '住宅小区建设项目', '某房地产公司', '某施工单位', 8000.00, '上海市浦东新区', '2025-02-10', '2025-03-01',
        '在建', 300.00, '部分缴纳', '存款', 1, 3, '2025-03-03 15:52:29', '2025-03-03 15:52:29');
/*!40000 ALTER TABLE `project`
    ENABLE KEYS */;
UNLOCK TABLES;
...
(
  ...
  AUTO_INCREMENT = 6
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='项目参与单位表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40000 ALTER TABLE `project_company`
    DISABLE KEYS */;
INSERT INTO `project_company`
VALUES (1, 1, '建设单位', '某市政建设局', '张建设', '13888880001'),
       (2, 1, '总承包', '某建筑公司', '李施工', '13999990002'),
       (3, 1, '监理单位', '某工程监理公司', '王监理', '13777770003'),
       (4, 2, '建设单位', '某房地产公司', '赵房建', '13666660004'),
       (5, 2, '总承包', '某施工单位', '钱工程', '13555550005');
/*!40000 ALTER TABLE `project_company`
    ENABLE KEYS */;
UNLOCK TABLES;
...
(
  ...
  AUTO_INCREMENT = 5
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='项目阶段表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40000 ALTER TABLE `project_phase`
    DISABLE KEYS */;
INSERT INTO `project_phase`
VALUES (1, 1, '立项', '2025-01-01', '2025-01-10', '已完成'),
       (2, 1, '施工', '2025-02-01', NULL, '进行中'),
       (3, 2, '立项', '2025-02-15', '2025-02-20', '已完成'),
       (4, 2, '施工', '2025-03-01', NULL, '进行中');
/*!40000 ALTER TABLE `project_phase`
    ENABLE KEYS */;
UNLOCK TABLES;
...
(
  ...
  AUTO_INCREMENT = 3
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='风险评估记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40000 ALTER TABLE `risk_assessment`
    DISABLE KEYS */;
INSERT INTO `risk_assessment`
VALUES (1, 1, '中风险', '2025-03-01', 3, '项目进度缓慢，存在工期延误风险', '增加施工人员，加快施工进度'),
       (2, 2, '高风险', '2025-03-02', 3, '发现施工质量存在问题，可能导致安全事故', '加强质量检查，确保施工规范执行');
/*!40000 ALTER TABLE `risk_assessment`
    ENABLE KEYS */;
UNLOCK TABLES;
...
(
  ...
  AUTO_INCREMENT = 6
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='短信验证码表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40000 ALTER TABLE `sms_code`
    DISABLE KEYS */;
INSERT INTO `sms_code`
VALUES (1, '13812345678', '563482', 'login', '2025-03-04 10:30:00', '2025-03-03 15:52:29'),
       (2, '13987654321', '834927', 'register', '2025-03-04 10:40:00', '2025-03-03 15:52:29'),
       (3, '13765439876', '927614', 'password_reset', '2025-03-04 11:00:00', '2025-03-03 15:52:29'),
       (4, '13654329876', '618294', 'login', '2025-03-04 11:15:00', '2025-03-03 15:52:29'),
       (5, '13543218765', '492738', 'register', '2025-03-04 12:00:00', '2025-03-03 15:52:29');
/*!40000 ALTER TABLE `sms_code`
    ENABLE KEYS */;
UNLOCK TABLES;
...
(
  ...
  AUTO_INCREMENT = 3
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='统计报表存储表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
VALUES (1, 'role', 'admin', '管理员', 1),
       (2, 'role', 'user', '普通用户', 2),
       (3, 'case_status', 'pending', '待受理', 1),
       (4, 'case_status', 'processing', '处理中', 2),
       (5, 'case_status', 'completed', '已办结', 3);
/*!40000 ALTER TABLE `sys_dict`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `sys_log`
    DISABLE KEYS */;
INSERT INTO `sys_log`
VALUES (1, 1, '用户管理', '新增', '添加新用户 user1', '192.168.1.1', '2025-03-03 15:52:30'),
       (2, 3, '项目管理', '修改', '更新项目合同金额', '192.168.1.2', '2025-03-03 15:52:30');
/*!40000 ALTER TABLE `sys_log`
    ENABLE KEYS */;
UNLOCK TABLES;
...
(
  ...
  AUTO_INCREMENT = 3
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='系统通知公告表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
VALUES (1, '系统维护公告', '系统将于2025-03-10 00:00进行维护', 1, '2025-03-03 15:52:30', NULL),
       (2, '工资发放通知', '三月份工资已发放，请查收', 3, '2025-03-03 15:52:30', NULL);
/*!40000 ALTER TABLE `sys_notice`
    ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES (1, '用户管理', 'system:user:list', 'user', '/user/list'),
       (2, '角色管理', 'system:role:list', 'role', '/role/list'),
       (3, '项目管理', 'project:manage', 'project', '/project/list'),
       (4, '案件管理', 'case:manage', 'case', '/case/list'),
       (5, '工资发放', 'wage:payment', 'money', '/wage/payment');
/*!40000 ALTER TABLE `sys_permission`
    ENABLE KEYS */;
UNLOCK TABLES;
...
VALUES (1, '管理员', 'admin', '系统管理员，具有所有权限'),
       (2, '普通用户', 'user', '普通用户，具有基本访问权限'),
       (3, '项目经理', 'project_manager', '负责项目的管理和审批'),
       (4, '案件管理员', 'case_manager', '负责案件的受理和处理');
/*!40000 ALTER TABLE `sys_role`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `user`
    DISABLE KEYS */;
INSERT INTO `user`
VALUES (1, 'admin', 'hashed_password', '13800001111', 'admin@example.com', '张伟', 1, '系统管理', '系统管理员',
        '2025-03-03 15:52:29', '2025-03-03 15:52:29'),
       (2, 'user1', 'hashed_password', '13900002222', 'user1@example.com', '李娜', 2, '工程部', '普通用户',
        '2025-03-03 15:52:29', '2025-03-03 15:52:29'),
       (3, 'pm1', 'hashed_password', '13700003333', 'pm1@example.com', '王强', 3, '工程部', '项目经理',
        '2025-03-03 15:52:29', '2025-03-03 15:52:29'),
       (4, 'case_mgr', 'hashed_password', '13600004444', 'case_mgr@example.com', '赵敏', 4, '法务部', '案件管理员',
        '2025-03-03 15:52:29', '2025-03-03 15:52:29');
/*!40000 ALTER TABLE `user`
    ENABLE KEYS */;
UNLOCK TABLES;
...
(
  ...
  AUTO_INCREMENT = 3
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='工资发放记录表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40000 ALTER TABLE `wage_payment`
    DISABLE KEYS */;
INSERT INTO `wage_payment`
VALUES (1, 1, '赵四', '110101199001011234', 5000.00, '2025-03-01', '银行转账', NULL),
       (2, 2, '钱六', '310101198802021234', 4500.00, '2025-03-02', '现金', NULL);
/*!40000 ALTER TABLE `wage_payment`
    ENABLE KEYS */;
UNLOCK TABLES;
